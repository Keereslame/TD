...
#         cv.destroyAllWindows() # destroys the window showing image
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_rotate_crop/crop_side/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_left_crop.jpg', crop_image_left)
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_rotate_crop/crop_side/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_right_crop.jpg', crop_image_right)

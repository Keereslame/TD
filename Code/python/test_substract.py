...
for i in range(nb_series):
    for j in range(nb_photo-1):
        ...
        imageA = cv.imread('/home/pi/Documents/TD/photo/samba/photo_split/serie{}'.format(i+1) + '_image{0}'.format(j) + '_right.jpg')
        imageB = cv.imread('/home/pi/Documents/TD/photo/samba/photo_split/serie{}'.format(i+1) + '_image{0}'.format(j+1) + '_right.jpg')
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/subtract/diff_sans_modif/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_right.jpg', image_diff_right)
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/subtract/diff_sans_modif/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_right_binary.jpg', opening_right)
        
        imageC = cv.imread('/home/pi/Documents/TD/photo/samba/photo_split/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_left.jpg')
        imageD = cv.imread('/home/pi/Documents/TD/photo/samba/photo_split/serie{0}'.format(i+1) + '_image{0}'.format(j+1) + '_left.jpg')
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/subtract/diff_sans_modif/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_left.jpg', image_diff_left)
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/subtract/diff_sans_modif/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_left_binary.jpg', opening_left)

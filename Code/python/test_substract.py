...
for i in range(nb_series):
    for j in range(nb_photo-1):
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_right.jpg', image_diff_right)
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_right_binary.jpg', opening_right)
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_left.jpg', image_diff_left)
        ...
        cv.imwrite('/home/pi/Documents/TD/photo/samba/photo_diff/serie{0}'.format(i+1) + '_image{0}'.format(j) + '_diff_left_binary.jpg', opening_left)
